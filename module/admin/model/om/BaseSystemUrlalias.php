 ...
 */
abstract class BaseSystemUrlalias extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'SystemUrlaliasPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SystemUrlaliasPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SystemUrlaliasPeer::ID;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[] = SystemUrlaliasPeer::URL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = SystemUrlaliasPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SystemUrlalias object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SystemUrlaliasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SystemUrlaliasQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SystemUrlaliasPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SystemUrlaliasPeer::ID)) {
    ...
    {
        $pos = SystemUrlaliasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['SystemUrlalias'][$this->getPrimaryKey()] = true;
        $keys = SystemUrlaliasPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUrl(),
    ...
    {
        $criteria = new Criteria(SystemUrlaliasPeer::DATABASE_NAME);
        $criteria->add(SystemUrlaliasPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of SystemUrlalias (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 SystemUrlalias Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   SystemUrlaliasPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SystemUrlaliasPeer();
        }
    ...
    {
        return (string) $this->exportTo(SystemUrlaliasPeer::DEFAULT_STRING_FORMAT);
    }
