...
abstract class BaseLog extends BaseObject 
{
    ...
    public function setUsername($v)
    {
        ...
        if ($this->username !== $v) {
            $this->username = $v;
            $this->modifiedColumns[] = LogPeer::USERNAME;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LogPeer::USERNAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LogPeer::USERNAME)) $criteria->add(LogPeer::USERNAME, $this->username);
