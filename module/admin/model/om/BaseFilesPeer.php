...
abstract class BaseFilesPeer {
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (FilesPeer::ID, FilesPeer::PATH, FilesPeer::CONTENTHASH, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (FilesPeer::ID => 0, FilesPeer::PATH => 1, FilesPeer::CONTENTHASH => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FilesPeer::PATH);
            $criteria->addSelectColumn(FilesPeer::CONTENTHASH);
        } else {
