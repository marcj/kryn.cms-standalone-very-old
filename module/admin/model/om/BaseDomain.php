 ...
 */
abstract class BaseDomain extends BaseObject 
{
    ...
    public function setDomain($v)
    {
        ...
        if ($this->domain !== $v) {
            $this->domain = $v;
            $this->modifiedColumns[] = DomainPeer::DOMAIN;
        }
    ...
    public function setTitleFormat($v)
    {
        ...
        if ($this->title_format !== $v) {
            $this->title_format = $v;
            $this->modifiedColumns[] = DomainPeer::TITLE_FORMAT;
        }
    ...
    public function setLang($v)
    {
        ...
        if ($this->lang !== $v) {
            $this->lang = $v;
            $this->modifiedColumns[] = DomainPeer::LANG;
        }
    ...
    public function setStartpageId($v)
    {
        ...
        if ($this->startpage_id !== $v) {
            $this->startpage_id = $v;
            $this->modifiedColumns[] = DomainPeer::STARTPAGE_ID;
        }
    ...
    public function setAlias($v)
    {
        ...
        if ($this->alias !== $v) {
            $this->alias = $v;
            $this->modifiedColumns[] = DomainPeer::ALIAS;
        }
    ...
    public function setRedirect($v)
    {
        ...
        if ($this->redirect !== $v) {
            $this->redirect = $v;
            $this->modifiedColumns[] = DomainPeer::REDIRECT;
        }
    ...
    public function setPage404id($v)
    {
        ...
        if ($this->page404_id !== $v) {
            $this->page404_id = $v;
            $this->modifiedColumns[] = DomainPeer::PAGE404_ID;
        }
    ...
    public function setLayouts($v)
    {
        ...
        if ($this->layouts !== $v) {
            $this->layouts = $v;
            $this->modifiedColumns[] = DomainPeer::LAYOUTS;
        }
    ...
    public function setPhplocale($v)
    {
        ...
        if ($this->phplocale !== $v) {
            $this->phplocale = $v;
            $this->modifiedColumns[] = DomainPeer::PHPLOCALE;
        }
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = DomainPeer::PATH;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = DomainPeer::EMAIL;
        }
    ...
    public function setSearchIndexKey($v)
    {
        ...
        if ($this->search_index_key !== $v) {
            ...
            $this->modifiedColumns[] = DomainPeer::SEARCH_INDEX_KEY;
        }
    ...
    public function setRobots($v)
    {
        ...
        if ($this->robots !== $v) {
            $this->robots = $v;
            $this->modifiedColumns[] = DomainPeer::ROBOTS;
        }
    ...
    public function setFavicon($v)
    {
        ...
        if ($this->favicon !== $v) {
            $this->favicon = $v;
            $this->modifiedColumns[] = DomainPeer::FAVICON;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 21; // 21 = DomainPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DomainPeer::DOMAIN)) {
            $modifiedColumns[':p' . $index++]  = 'DOMAIN';
        }
        if ($this->isColumnModified(DomainPeer::TITLE_FORMAT)) {
            $modifiedColumns[':p' . $index++]  = 'TITLE_FORMAT';
        }
        if ($this->isColumnModified(DomainPeer::LANG)) {
            $modifiedColumns[':p' . $index++]  = 'LANG';
        }
        if ($this->isColumnModified(DomainPeer::STARTPAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'STARTPAGE_ID';
        }
        if ($this->isColumnModified(DomainPeer::ALIAS)) {
            $modifiedColumns[':p' . $index++]  = 'ALIAS';
        }
        if ($this->isColumnModified(DomainPeer::REDIRECT)) {
        ...
        if ($this->isColumnModified(DomainPeer::PHPLOCALE)) {
        ...
        if ($this->isColumnModified(DomainPeer::SEARCH_INDEX_KEY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DomainPeer::DOMAIN)) $criteria->add(DomainPeer::DOMAIN, $this->domain);
        if ($this->isColumnModified(DomainPeer::TITLE_FORMAT)) $criteria->add(DomainPeer::TITLE_FORMAT, $this->title_format);
        if ($this->isColumnModified(DomainPeer::LANG)) $criteria->add(DomainPeer::LANG, $this->lang);
        if ($this->isColumnModified(DomainPeer::STARTPAGE_ID)) $criteria->add(DomainPeer::STARTPAGE_ID, $this->startpage_id);
