...
/**
 * Base class that represents a row from the 'kryn_system_urlalias' table.
 *
 * 
 *
 * @package    propel.generator.kryn.om
 */
abstract class BaseUrlalias extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'UrlaliasPeer';
     ...
     * @return   Urlalias The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = UrlaliasPeer::ID;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[] = UrlaliasPeer::URL;
        }
    ...
    public function setToPageId($v)
    {
        ...
        if ($this->to_page_id !== $v) {
            $this->to_page_id = $v;
            $this->modifiedColumns[] = UrlaliasPeer::TO_PAGE_ID;
        }
    ...
    public function setDomainId($v)
    {
        ...
        if ($this->domain_id !== $v) {
            $this->domain_id = $v;
            $this->modifiedColumns[] = UrlaliasPeer::DOMAIN_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = UrlaliasPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Urlalias object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPage !== null && $this->to_page_id !== $this->aPage->getId()) {
            $this->aPage = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UrlaliasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UrlaliasQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UrlaliasPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {				
				$stmt = $con->query("SELECT nextval('kryn_system_urlalias_id_seq')");
				$row = $stmt->fetch(PDO::FETCH_NUM);
				$this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(UrlaliasPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(UrlaliasPeer::URL)) {
            $modifiedColumns[':p' . $index++]  = 'URL';
        }
        if ($this->isColumnModified(UrlaliasPeer::TO_PAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'TO_PAGE_ID';
        }
        if ($this->isColumnModified(UrlaliasPeer::DOMAIN_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DOMAIN_ID';
        }

        $sql = sprintf(
            'INSERT INTO kryn_system_urlalias (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UrlaliasPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UrlaliasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Urlalias'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Urlalias'][$this->getPrimaryKey()] = true;
        $keys = UrlaliasPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUrl(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UrlaliasPeer::ID)) $criteria->add(UrlaliasPeer::ID, $this->id);
        if ($this->isColumnModified(UrlaliasPeer::URL)) $criteria->add(UrlaliasPeer::URL, $this->url);
        if ($this->isColumnModified(UrlaliasPeer::TO_PAGE_ID)) $criteria->add(UrlaliasPeer::TO_PAGE_ID, $this->to_page_id);
        if ($this->isColumnModified(UrlaliasPeer::DOMAIN_ID)) $criteria->add(UrlaliasPeer::DOMAIN_ID, $this->domain_id);
    ...
    {
        $criteria = new Criteria(UrlaliasPeer::DATABASE_NAME);
        $criteria->add(UrlaliasPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of Urlalias (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 Urlalias Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aPage === null && ($this->to_page_id !== null)) {
            $this->aPage = PageQuery::create()->findPk($this->to_page_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPage->addUrlaliass($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UrlaliasPeer::DEFAULT_STRING_FORMAT);
    }
