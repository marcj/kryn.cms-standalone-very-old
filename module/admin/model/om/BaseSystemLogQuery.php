 ...
 * @method     SystemLogQuery orderByDate($order = Criteria::ASC) Order by the date column
 * @method     SystemLogQuery orderByUsername($order = Criteria::ASC) Order by the username column
 * @method     SystemLogQuery orderByIp($order = Criteria::ASC) Order by the ip column
 ...
 * @method     SystemLogQuery groupByDate() Group by the date column
 * @method     SystemLogQuery groupByUsername() Group by the username column
 * @method     SystemLogQuery groupByIp() Group by the ip column
 ...
 *
 * @method     SystemLog findOneById(int $id) Return the first SystemLog filtered by the id column
 * @method     SystemLog findOneByDate(int $date) Return the first SystemLog filtered by the date column
 * @method     SystemLog findOneByUsername(string $username) Return the first SystemLog filtered by the username column
 * @method     SystemLog findOneByIp(string $ip) Return the first SystemLog filtered by the ip column
 * @method     SystemLog findOneByCode(string $code) Return the first SystemLog filtered by the code column
 ...
 * @method     array findByDate(int $date) Return SystemLog objects filtered by the date column
 * @method     array findByUsername(string $username) Return SystemLog objects filtered by the username column
 * @method     array findByIp(string $ip) Return SystemLog objects filtered by the ip column
 * @method     array findByCode(string $code) Return SystemLog objects filtered by the code column
...
abstract class BaseSystemLogQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'kryn', $modelName = 'SystemLog', $modelAlias = null)
    {
    ...
    public function filterByDate($date = null, $comparison = null)
    {
        if (is_array($date)) {
            $useMinMax = false;
            if (isset($date['min'])) {
                $this->addUsingAlias(SystemLogPeer::DATE, $date['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($date['max'])) {
                $this->addUsingAlias(SystemLogPeer::DATE, $date['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SystemLogPeer::DATE, $date, $comparison);
    }
    ...
    public function filterByUsername($username = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SystemLogPeer::USERNAME, $username, $comparison);
    }
    ...
    public function filterByIp($ip = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SystemLogPeer::IP, $ip, $comparison);
    }
