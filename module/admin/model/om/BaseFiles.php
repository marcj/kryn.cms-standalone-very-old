 ...
 */
abstract class BaseFiles extends BaseObject 
{
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = FilesPeer::PATH;
        }
    ...
    public function setContenthash($v)
    {
        ...
        if ($this->contenthash !== $v) {
            $this->contenthash = $v;
            $this->modifiedColumns[] = FilesPeer::CONTENTHASH;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = FilesPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FilesPeer::PATH)) {
            $modifiedColumns[':p' . $index++]  = 'PATH';
        }
        if ($this->isColumnModified(FilesPeer::CONTENTHASH)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FilesPeer::PATH)) $criteria->add(FilesPeer::PATH, $this->path);
        if ($this->isColumnModified(FilesPeer::CONTENTHASH)) $criteria->add(FilesPeer::CONTENTHASH, $this->contenthash);
