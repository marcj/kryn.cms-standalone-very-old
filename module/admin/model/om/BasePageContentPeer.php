...
abstract class BasePageContentPeer {
    ...
    /**
     * An identiy map to hold any loaded instances of PageContent objects.
    ...
    {
        $toNames = PageContentPeer::getFieldNames($toType);
        $key = isset(PageContentPeer::$fieldKeys[$fromType][$name]) ? PageContentPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PageContentPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PageContentPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PageContentPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. PageContentPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(PageContentPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PageContentPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = PageContentPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return PageContentPeer::populateObjects(PageContentPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param      PageContent $obj A PageContent object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            PageContentPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A PageContent object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof PageContent) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or PageContent object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(PageContentPeer::$instances[$key]);
        }
     ...
     * @return   PageContent Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PageContentPeer::$instances[$key])) {
                return PageContentPeer::$instances[$key];
            }
        }
    ...
    {
        PageContentPeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = PageContentPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = PageContentPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                PageContentPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (PageContent object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = PageContentPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = PageContentPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + PageContentPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PageContentPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Propel::getDatabaseMap(PageContentPeer::DATABASE_NAME)->getTable(PageContentPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BasePageContentPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BasePageContentPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new PageContentTableMap());
      }
    }
    ...
    {
        return PageContentPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a PageContent or Criteria object.
     *
     * @param      mixed $values Criteria or PageContent object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from PageContent object
        }

        if ($criteria->containsKey(PageContentPeer::ID) && $criteria->keyContainsValue(PageContentPeer::ID) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a PageContent or Criteria object.
     *
     * @param      mixed $values Criteria or PageContent object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PageContentPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(PageContentPeer::ID);
            $value = $criteria->remove(PageContentPeer::ID);
            if ($value) {
                $selectCriteria->add(PageContentPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(PageContentPeer::TABLE_NAME);
            }

        } else { // $values is PageContent object
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(PageContentPeer::TABLE_NAME, $con, PageContentPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            PageContentPeer::clearInstancePool();
            PageContentPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a PageContent or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or PageContent object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof PageContent) { // it's a model object
            // invalidate the cache for this single object
            PageContentPeer::removeInstanceFromPool($values);
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(PageContentPeer::DATABASE_NAME);
            $criteria->add(PageContentPeer::ID, (array) $values, Criteria::IN);
            // invalidate the cache for this object(s)
            foreach ((array) $values as $singleval) {
                PageContentPeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    /**
     * Validates all modified columns of given PageContent object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      PageContent $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(PageContentPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(PageContentPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(PageContentPeer::DATABASE_NAME, PageContentPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = PageContentPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(PageContentPeer::DATABASE_NAME);
        $criteria->add(PageContentPeer::ID, $pk);

        $v = PageContentPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PageContentPeer::DATABASE_NAME);
            $criteria->add(PageContentPeer::ID, $pks, Criteria::IN);
            $objs = PageContentPeer::doSelect($criteria, $con);
        }
...
//
BasePageContentPeer::buildTableMap();
