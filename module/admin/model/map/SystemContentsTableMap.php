...
/**
 * This class defines the structure of the 'kryn_system_contents' table.
 *
 *
 *
 ...
 */
class SystemContentsTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'kryn.map.SystemContentsTableMap';
    ...
    {
        // attributes
        $this->setName('kryn_system_contents');
        $this->setPhpName('SystemContents');
        $this->setClassname('SystemContents');
        $this->setPackage('kryn');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('kryn_system_contents_id_seq');
        // columns
