 ...
 */
class SystemSearchTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'kryn.map.SystemSearchTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('SystemSearch');
        $this->setClassname('SystemSearch');
