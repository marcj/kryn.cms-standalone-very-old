 ...
 */
class SystemFilesVersionsTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'kryn.map.SystemFilesVersionsTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('SystemFilesVersions');
        $this->setClassname('SystemFilesVersions');
