 ...
 */
class SystemSearchStatsTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'kryn.map.SystemSearchStatsTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('SystemSearchStats');
        $this->setClassname('SystemSearchStats');
