 ...
 */
class SystemFilesLogTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'kryn.map.SystemFilesLogTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('SystemFilesLog');
        $this->setClassname('SystemFilesLog');
