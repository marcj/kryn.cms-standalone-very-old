 ...
 */
class SystemPageTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'kryn.map.SystemPageTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('SystemPage');
        $this->setClassname('SystemPage');
    ...
    {
        $this->addRelation('SystemDomain', 'SystemDomain', RelationMap::MANY_TO_ONE, array('domain_id' => 'id', ), 'CASCADE', null);
        $this->addRelation('SystemUrlalias', 'SystemUrlalias', RelationMap::ONE_TO_MANY, array('id' => 'to_page_id', ), null, null, 'SystemUrlaliass');
    } // buildRelations()
