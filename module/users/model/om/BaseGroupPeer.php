...
/**
 * Base static class for performing query and update operations on the 'kryn_system_group' table.
 *
 * 
 *
...
abstract class BaseGroupPeer {
    ...
    const ID = 'kryn_system_group.ID';

    /** the column name for the CLOSE field */
    const CLOSE = 'kryn_system_group.CLOSE';

    /** the column name for the NAME field */
    const NAME = 'kryn_system_group.NAME';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'kryn_system_group.DESCRIPTION';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Close', 'Name', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'close', 'name', 'description', ),
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID, GroupPeer::CLOSE, GroupPeer::NAME, GroupPeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CLOSE', 'NAME', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'close', 'name', 'description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Close' => 1, 'Name' => 2, 'Description' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'close' => 1, 'name' => 2, 'description' => 3, ),
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID => 0, GroupPeer::CLOSE => 1, GroupPeer::NAME => 2, GroupPeer::DESCRIPTION => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CLOSE' => 1, 'NAME' => 2, 'DESCRIPTION' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'close' => 1, 'name' => 2, 'description' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupPeer::CLOSE);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to kryn_system_group
    ...
    /**
     * Deletes all rows from the kryn_system_group table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
