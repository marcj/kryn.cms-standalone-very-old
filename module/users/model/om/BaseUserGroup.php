...
/**
 * Base class that represents a row from the 'kryn_system_user_group' table.
 *
 * 
 *
 * @package    propel.generator.Kryn.om
 */
abstract class BaseUserGroup extends BaseObject 
{
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO kryn_system_user_group (%s) VALUES (%s)',
