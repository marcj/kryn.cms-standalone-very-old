...
/**
 * Base class that represents a row from the 'kryn_system_session' table.
 *
 * 
 *
 * @package    propel.generator.Kryn.om
 */
abstract class BaseSession extends BaseObject 
{
    ...
    /**
     * The value for the refreshed field.
     * @var        int
     */
    protected $refreshed;
    ...
    /**
     * Get the [refreshed] column value.
     * 
     * @return   int
     */
    ...
    public function setIp($v)
    {
        ...
        if ($this->ip !== $v) {
            $this->ip = $v;
            $this->modifiedColumns[] = SessionPeer::IP;
        }
    ...
    public function setUseragent($v)
    {
        ...
        if ($this->useragent !== $v) {
            $this->useragent = $v;
            $this->modifiedColumns[] = SessionPeer::USERAGENT;
        }
    ...
    public function setLanguage($v)
    {
        ...
        if ($this->language !== $v) {
            $this->language = $v;
            $this->modifiedColumns[] = SessionPeer::LANGUAGE;
        }
    ...
    public function setPage($v)
    {
        ...
        if ($this->page !== $v) {
            $this->page = $v;
            $this->modifiedColumns[] = SessionPeer::PAGE;
        }
    ...
    /**
     * Set the value of [refreshed] column.
     * 
     * @param      int $v new value
     * @return   Session The current object (for fluent API support)
     */
    public function setRefreshed($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->refreshed !== $v) {
            $this->refreshed = $v;
            $this->modifiedColumns[] = SessionPeer::REFRESHED;
        }
    ...
    public function setExtra($v)
    {
        ...
        if ($this->extra !== $v) {
            $this->extra = $v;
            $this->modifiedColumns[] = SessionPeer::EXTRA;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== $v) {
            $this->created = $v;
            $this->modifiedColumns[] = SessionPeer::CREATED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->useragent = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->language = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->page = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->refreshed = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->extra = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            ...
            return $startcol + 10; // 10 = SessionPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SessionPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }
        if ($this->isColumnModified(SessionPeer::TIME)) {
            $modifiedColumns[':p' . $index++]  = 'TIME';
        }
        if ($this->isColumnModified(SessionPeer::IP)) {
            $modifiedColumns[':p' . $index++]  = 'IP';
        }
        if ($this->isColumnModified(SessionPeer::USERAGENT)) {
            $modifiedColumns[':p' . $index++]  = 'USERAGENT';
        }
        if ($this->isColumnModified(SessionPeer::LANGUAGE)) {
            $modifiedColumns[':p' . $index++]  = 'LANGUAGE';
        }
        if ($this->isColumnModified(SessionPeer::PAGE)) {
            $modifiedColumns[':p' . $index++]  = 'PAGE';
        }
        if ($this->isColumnModified(SessionPeer::REFRESHED)) {
            $modifiedColumns[':p' . $index++]  = 'REFRESHED';
        }
        if ($this->isColumnModified(SessionPeer::EXTRA)) {
            $modifiedColumns[':p' . $index++]  = 'EXTRA';
        }
        if ($this->isColumnModified(SessionPeer::CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'CREATED';
        }

        $sql = sprintf(
            'INSERT INTO kryn_system_session (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'PAGE':
                        ...
                        break;
                    case 'REFRESHED':
						$stmt->bindValue($identifier, $this->refreshed, PDO::PARAM_INT);
                        break;
                    case 'EXTRA':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getPage(),
            $keys[7] => $this->getRefreshed(),
            $keys[8] => $this->getExtra(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setPage($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setRefreshed($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setExtra($arr[$keys[8]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SessionPeer::IP)) $criteria->add(SessionPeer::IP, $this->ip);
        if ($this->isColumnModified(SessionPeer::USERAGENT)) $criteria->add(SessionPeer::USERAGENT, $this->useragent);
        if ($this->isColumnModified(SessionPeer::LANGUAGE)) $criteria->add(SessionPeer::LANGUAGE, $this->language);
        if ($this->isColumnModified(SessionPeer::PAGE)) $criteria->add(SessionPeer::PAGE, $this->page);
        if ($this->isColumnModified(SessionPeer::REFRESHED)) $criteria->add(SessionPeer::REFRESHED, $this->refreshed);
        if ($this->isColumnModified(SessionPeer::EXTRA)) $criteria->add(SessionPeer::EXTRA, $this->extra);
        if ($this->isColumnModified(SessionPeer::CREATED)) $criteria->add(SessionPeer::CREATED, $this->created);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setRefreshed($this->getRefreshed());
