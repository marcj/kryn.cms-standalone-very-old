...
/**
 * Base static class for performing query and update operations on the 'kryn_system_user' table.
 *
 * 
 *
...
abstract class BaseUserPeer {
    ...
    const TABLE_NAME = 'kryn_system_user';
    ...
    const USERNAME = 'kryn_system_user.USERNAME';

    /** the column name for the AUTH_CLASS field */
    const AUTH_CLASS = 'kryn_system_user.AUTH_CLASS';

    /** the column name for the PASSWD field */
    const PASSWD = 'kryn_system_user.PASSWD';

    /** the column name for the PASSWD_SALT field */
    const PASSWD_SALT = 'kryn_system_user.PASSWD_SALT';

    /** the column name for the ACTIVATIONKEY field */
    const ACTIVATIONKEY = 'kryn_system_user.ACTIVATIONKEY';

    /** the column name for the EMAIL field */
    const EMAIL = 'kryn_system_user.EMAIL';

    /** the column name for the DESKTOP field */
    const DESKTOP = 'kryn_system_user.DESKTOP';
    ...
    const LAST_NAME = 'kryn_system_user.LAST_NAME';

    /** the column name for the SEX field */
    const SEX = 'kryn_system_user.SEX';

    /** the column name for the LOGINS field */
    const LOGINS = 'kryn_system_user.LOGINS';

    /** the column name for the LASTLOGIN field */
    const LASTLOGIN = 'kryn_system_user.LASTLOGIN';

    /** the column name for the ACTIVATE field */
    const ACTIVATE = 'kryn_system_user.ACTIVATE';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::AUTH_CLASS);
            $criteria->addSelectColumn(UserPeer::PASSWD);
            $criteria->addSelectColumn(UserPeer::PASSWD_SALT);
            $criteria->addSelectColumn(UserPeer::ACTIVATIONKEY);
            ...
            $criteria->addSelectColumn(UserPeer::ACTIVATE);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.USERNAME');
            $criteria->addSelectColumn($alias . '.AUTH_CLASS');
            $criteria->addSelectColumn($alias . '.PASSWD');
            $criteria->addSelectColumn($alias . '.PASSWD_SALT');
    ...
    /**
     * Method to invalidate the instance pool of all tables related to kryn_system_user
    ...
    /**
     * Deletes all rows from the kryn_system_user table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
