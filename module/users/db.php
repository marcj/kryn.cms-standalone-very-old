...
$db[ 'users_log' ] = array(
    'id'    => array('int', null, DB_PRIMARY, true),
...
$db[ 'system_groupaccess' ] = array(
    'group_id'  => array('int', null, DB_PRIMARY),
    'user_id'    => array('int', null, DB_PRIMARY),
);
...
$db[ 'system_sessions' ] = array(
    ...
    'user_id' => array('int', null, DB_INDEX),
    'time'    => array('int'),
    'ip'      => array('varchar', 25),
...
$db[ 'system_acl' ] = array(
    ...
    'target_id' => array('int', null, DB_INDEX),
