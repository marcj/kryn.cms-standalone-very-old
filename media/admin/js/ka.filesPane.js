ka.filesPane = new Class({
    ...
    createNavigation: function () {
        ...
        buttonGrp.addButton('Hoch', _path + PATH_MEDIA + '/admin/images/admin-files-toLeft.png', this.toUp.bind(this));

        var viewGrp = new ka.buttonGroup(this.navigationBar);
        this.viewButtons['icons'] = viewGrp.addButton('Icons', _path + PATH_MEDIA + '/admin/images/admin-files-list-icons.png', this.toViewMode.bind(this, 'icons'));
        this.viewButtons['miniatur'] = viewGrp.addButton('Miniatur', _path + PATH_MEDIA + '/admin/images/admin-files-list-miniatur.png', this.toViewMode.bind(this, 'miniatur'));
        this.viewButtons['detail'] = viewGrp.addButton('Detail', _path + PATH_MEDIA + '/admin/images/admin-files-list-detail.png', this.toViewMode.bind(this, 'detail'));
        ...
        //var uploadBtn = boxAction.addButton( 'Datei hochladen', _path+ PATH_MEDIA + '/admin/images/admin-files-uploadFile.png', this.startUpload.bind(this) );
        var uploadBtn = boxAction.addButton(_('Upload file'), _path + PATH_MEDIA + '/admin/images/admin-files-uploadFile.png', function () {
        });
        ...
        this.userFilesBtn = userGrp.addButton('Systemordner ausblenden', _path + PATH_MEDIA + '/admin/images/icons/folder_brick.png', this.toggleUserMode.bind(this));
    ...
    initSWFUpload: function () {
        ...
        ka.uploads[this.win.id] = new SWFUpload({
            ...
            file_post_name: "file",
            flash_url: _path + PATH_MEDIA + "/admin/swfupload.swf",
    ...
    addFileDetail: function (pFile) {
        ...
        var image = new Element('img', {
            src: _path + PATH_MEDIA + '/admin/images/ext/' + bg + '-mini.png'
        });
