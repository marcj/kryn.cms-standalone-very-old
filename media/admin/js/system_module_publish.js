var admin_system_module_publish = new Class({
    ...
    initialize: function (pWin) {
        ...
        if (ka.settings.system.communityId > 0) {
            this.uploadBtn = this.topGroup.addButton(_('Upload this version'), _path + PATH_MEDIA + '/admin/images/icons/add.png', this.add.bind(this));
        }
        this.createPkg = this.topGroup.addButton(_('Create package'), _path + PATH_MEDIA + '/admin/images/icons/compress.png', this.getPackage.bind(this));
