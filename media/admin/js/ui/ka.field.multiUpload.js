ka.field_multiUpload = new Class({
    ...
    _renderMultiUpload: function () {
        ...
        this.uploadBtn = new Element('div', {
            ...
            'style': 'background : transparent url(' + _path + PATH_MEDIA + '/admin/images/admin-files-uploadFile.png) center center no-repeat;cursor:pointer;' }).inject(this.parentField.main);
    ...
    _addUploadedFileToPanel: function (pFile, pSecParam) {
        ...
        new Element('img', { 'src': _path + PATH_MEDIA + '/admin/images/icons/cross.png' }).inject(delBtn);
