ka.Files = new Class({
    ...
    uploadError: function (pFile) {
        ...
        if (ka.settings.upload_max_filesize && ka.settings.upload_max_filesize < pFile.size) {
            ...
            new Element('img', {
                ...
                src: _path + PATH_MEDIA + '/admin/images/icons/error.png',
    ...
    initSWFUpload: function () {
        ...
        ka.uploads[this.win.id] = new SWFUpload({
            ...
            file_post_name: "file",
            flash_url: _path + "media/admin/swfupload.swf",
    ...
    _createLayout: function () {
        ...
        this.userFilesBtn = userGrp.addButton(_('Hide system files'), _path + PATH_MEDIA + '/admin/images/icons/folder_brick.png', this.toggleUserMode.bind(this));
    ...
    updatePreview: function () {
        ...
        if (this.__images.contains(file.path.substr(file.path.lastIndexOf('.')).toLowerCase())) {
            ...
            if (file.type == 'dir')
                if (file.magic)
                    new Element('img', {src: _path+ PATH_MEDIA + '/admin/images/file-icon-magic.png'}).inject(this.previewDiv);
                else
                    new Element('img', {src: _path+ PATH_MEDIA + '/admin/images/file-icon-folder.png'}).inject(this.previewDiv);
            else
                new Element('img', {src: _path+ PATH_MEDIA + '/admin/images/file-icon-text.png'}).inject(this.previewDiv);
        }
        ...
        if (Object.getLength(selectedItems) > 0) {
            ...
            this.previewDivResizer = new Element('div', {
                style: 'position: absolute;right: -1px;bottom: -1px;width: 9px;'+
                       'height: 9px; opacity: 0.7; background-image: url('+_path+ PATH_MEDIA + '/admin/images/win-bottom-resize.png);'+
    ...
    renderDetail: function () {
        ...
        var pAdmin = _path + PATH_MEDIA + '/admin/';
    ...
    recover: function (pFile) {
        ...
        this.win._confirm(_('This file will be moved to: %s').replace('%s', '<br/><br/>' + pFile['original_path'].replace(PATH_MEDIA, '') + '<br/><br/>') + _('Are you really sure?'), function (res) {
            if (res) {
    ...
    _search: function (pQ) {
        ...
        this.searchPaneContent.set('html', '<div style="text-align: center; padding-top: 25px;">' + '<img src="' + _path + PATH_MEDIA + '/admin/images/ka-tooltip-loading.gif" /><br />' + _('Searching ...') + '</div>');
