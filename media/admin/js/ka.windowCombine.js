ka.windowCombine = new Class({
    ...
    renderActionbar: function () {
        ...
        Object.each(this.values.columns, function (column, id) {
            ...
            this.sortSelect.add(id + '______asc', _(column.label) + ' <img style="position: relative; top: -1px" src="' + _path + PATH_MEDIA + '/admin/images/icons/bullet_arrow_up_s.png" />');
            this.sortSelect.add(id + '______desc', _(column.label) + ' <img style="position: relative; top: -1px" src="' + _path + PATH_MEDIA + '/admin/images/icons/bullet_arrow_down_s.png" />');
            /*
             new Element('option', {
             text: _(column.label),
             value: id
