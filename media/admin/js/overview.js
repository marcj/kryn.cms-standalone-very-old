admin_overview = new Class({
    initialize: function (pWindow) {
        ...
        //this.buttons['general'] = this.topGroup.addButton(_('General'), _path+ PATH_MEDIA + '/admin/images/admin-pages-viewType-general.png', this.viewType.bind(this,'general'));
        //this.buttons['system'] = this.topGroup.addButton(_('System'), _path+ PATH_MEDIA + '/admin/images/icons/computer.png', this.viewType.bind(this,'system'));
        //this.buttons['statistic'] = this.topGroup.addButton(_('Statistic'), _path+ PATH_MEDIA + '/admin/images/icons/chart_pie.png', this.viewType.bind(this,'statistic'));
        ...
        new Request.JSON({url: _path + 'admin/widgets/getWidgets/', noCache: 1, onComplete: function (pExtensions) {
            ...
            $H(pExtensions).each(function (item, index) {
                ...
                var img = new Element('img', {
                    ...
                    function (e) {
                        if (this.lang == 0) {
                            this.src = _path + PATH_MEDIA + '/admin/images/icons/tree_minus.png';
                            this.lang = 1;
                        } else {
                            this.src = _path + PATH_MEDIA + '/admin/images/icons/tree_plus.png';
                            this.lang = 0;
                        }
