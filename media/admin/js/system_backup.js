var admin_system_backup = new Class({
    ...
    renderLayout: function () {
        ...
        this.btnNewBackup = this.btnGrp.addButton(_('New Backup'), _path + PATH_MEDIA + '/admin/images/icons/add.png', this.add.bind(this));
        this.btnImport = this.btnGrp.addButton(_('Import'), _path + PATH_MEDIA + '/admin/images/icons/database_import.png', this.import.bind(this));


        this.addGrp = this.win.addButtonGroup();
        this.addGrp.setStyle('margin-left', 130);
        this.addSaveBtn = this.addGrp.addButton(_('Save'), _path + PATH_MEDIA + '/admin/images/button-save.png', this.save.bind(this));

        this.addGenerateBtn = this.addGrp.addButton(_('Save and generate'), _path + PATH_MEDIA + '/admin/images/button-save-and-publish.png', this.generate.bind(this));
        this.addDeleteBtn = this.addGrp.addButton(_('Delete'), _path + PATH_MEDIA + '/admin/images/icons/delete.png', this.remove.bind(this));
