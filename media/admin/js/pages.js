var admin_pages = new Class({
    ...
    toggleHiderMode: function () {
        if (this.inHideMode != true) {
            ...
            this.treeHider.set('src', _path + PATH_MEDIA + '/admin/images/pages-tree-bar-arrow-down.jpg');
            ...
            this.treeHider.set('src', _path + PATH_MEDIA + '/admin/images/pages-tree-bar-arrow.jpg');
    ...
    _createLayout: function () {
        var p = _path + PATH_MEDIA + '/admin/images/';

        var btnGrp = this.win.addButtonGroup();
        btnGrp.addButton(_('New domain'), _path + PATH_MEDIA + '/admin/images/icons/world_add.png', this.addDomain.bind(this));
        ...
        this.treeBar = new Element('div', {
            styles: {
                ...
                cursor: 'pointer',
                'background-image': 'url(' + _path + PATH_MEDIA + '/admin/images/pages-tree-bar-bg.jpg)'
            }
        }).addEvent('click', this.toggleHiderMode.bind(this)).inject(this.tree, 'top');

        this.treeHider = new Element('img', {
            style: 'margin-left: 5px;',
            src: _path + PATH_MEDIA + '/admin/images/pages-tree-bar-arrow.jpg'
        }).inject(this.treeBar);
...
*/
    ...
    _createGeneral: function () {
        ...
        this.generalFields['type'] = new ka.field({label: _('Type'), type: 'imagegroup',
            ...
            items: {
                ...
                1: {label: _('Link'), src: _path + PATH_MEDIA + '/admin/images/icons/link.png'},
                2: {label: _('Folder'), src: _path + PATH_MEDIA + '/admin/images/icons/folder.png'},
                3: {label: _('Deposit'), src: _path + PATH_MEDIA + '/admin/images/icons/page_white_text.png'}
            }
        }).inject(p);
    ...
    _loadContent: function () {
        ...
        if (!this.iframe || !this.iframe.contentWindow || !this.iframe.contentWindow.Asset || !this.oldPage || (this.page.layout != layout) || (this.page.domain_rsn != this.oldPage.domain_rsn)) {
            this.__newIframe();
    ...
    _loadContentLayout: function () {
        ...
        this.oldLoadContentRequest = new Request.JSON({url: _path + 'admin/pages/getLayout', noCache: 1,
            onComplete: this._renderContentLayout.bind(this) }).post({ name: layout, rsn: this.page.rsn });
    ...
    __buildDragItem: function (element) {
        ...
        new Element('img', {
            src: _path + PATH_MEDIA + '/admin/images/ka-keditor-elementtypes-item-' + type + '-bg.png'
        }).inject(div);
    ...
    _renderContentLayout: function (pLayout) {
        ...
        //        this.layoutAsset = new w.Asset.css( _path+ PATH_MEDIA + '/css/layout_'+this.layout.getValue()+'.css' );
        ...
        if (pLayout.css) {
            pLayout.css.each(function (css) {
                var css = new Element('link', {
                    rel: "stylesheet",
                    type: "text/css",
                    href: _baseUrl + ((css.substr(0,1)=='/') ? css.substr(1) : PATH_MEDIA+css)
                }).inject(w.document.head);
                this.lastLoadedLayoutCssFiles.include(css); //w.Asset.css( _path+PATH_MEDIA+css) );
            }.bind(this));
        }
        ...
        if (pValues.versions.count == 0) {
            ...
            pValues.versions.each(function (item) {
                ...
                this.versionTable.addRow([
                    item.rsn, new Element('img', {src: _path + PATH_MEDIA + '/admin/images/icons/' + ((pValues.active == 1) ? 'accept' : 'delete') + '.png'}), item.username, (new Date(item.created * 1000).format('%d.%m.%Y %H:%M')), actions
                ]);
    ...
    createVersionLine: function (pValues) {
        ...
        new Element('td', {
            html: '<img src="' + _path + PATH_MEDIA + '/admin/images/icons/' + icon + '.png" />',
            width: 50
        }).inject(tr);
    ...
    _createSearchIndexPane: function () {
        ...
        /*
         ...
         new Element('img', { 'src' : _path+ PATH_MEDIA + '/admin/images/icons/lightning_delete.png'}).inject(fieldAddToBlBtn);
        ...
        this.seachIndexOverviewRequest = new Request.JSON({url: _path + 'admin/backend/searchIndexer/getSearchIndexOverview', noCache: 1,
            onComplete: function (res) {
                ...
                res.each(function (pVal, pKey) {
                    ...
                    res[pKey][4] = '';
                    res[pKey][4] += '&nbsp;<a href="' + vUrl + '" target="_blank"><img src="' + _path + PATH_MEDIA + '/admin/images/icons/eye.png" title="' + _('View this page') + '" /></a>';
                }.bind(this));
