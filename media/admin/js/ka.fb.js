...
ka.fb = new Class({
    initialize: function (pTypes) {
        new Asset.css(_path + PATH_MEDIA + '/admin/filebrowser.css');
...
ka.fb_upload = new Class({
    initialize: function (pFileBrowser, pOptions) {
        new Asset.css(_path + PATH_MEDIA + '/admin/filebrowser.pictures.css');
...
ka.fb_pictures = new Class({
    ...
    createActionPane: function () {
        ...
        new Element('img', {
            src: _path + PATH_MEDIA + '/admin/images/icons/up.png',
            title: 'Aufwärts',
            styles: {
                cursor: 'pointer'
            }
    ...
    createItem: function (pItem) {
        var _this = this;
        var src = _path + PATH_MEDIA + '/admin/images/ext/dir.png';
        var validPic = false;
