var users_browser = new Class({
	...
	initialize: function( pWin ){
		...
		this.buttons = {};
		this.buttons['users'] = this.tabGroup.addButton(_('Users'), _path+ PATH_MEDIA + '/admin/images/icons/user.png', this.selectTab.bind(this, 'users'));
		this.buttons['groups'] = this.tabGroup.addButton(_('Groups'), _path+ PATH_MEDIA + '/admin/images/icons/group.png', this.selectTab.bind(this, 'groups'));
