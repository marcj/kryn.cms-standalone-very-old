    ...
    loadInstalled: function () {
        ...
        this.llir = new Request.JSON({url: _path + 'admin/system/module/loadInstalled', noCache: 1, onComplete: function (res) {
            ...
            Object.each(res, function (item, key) {
                ...
                var value = [title, '<img title="' + _title + '" src="' + _path + 'inc/template/admin/images/icons/' + icon + '.png" />', item.version, (item.serverVersion) ? item.serverVersion : _('Local'), actionsStatus, actions];
