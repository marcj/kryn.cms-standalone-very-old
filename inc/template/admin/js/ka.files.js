ka.files = new Class({
    ...
    newFileUpload: function (pFile) {
        ...
        if (ka.settings.upload_max_filesize && ka.settings.upload_max_filesize < pFile.size) {
            ...
            if (pFile.html5)
                this.fileUploadCheck(this.html5FileUploads[ pFile.id ]); else
    ...
    paste: function () {
        ...
        if (move == 1)
            this.moveFiles(files, this.current); else
    ...
    renderIcons: function (pItems) {
        ...
        if (pItems) {
            ...
            pItems.each(function (item) {
                if (item.type != 'dir') {
                    if (this.current == '/')
                        files.include(this.__buildItem(item)); else
    ...
    __buildItem: function (pFile) {
        ...
        if (this.__images.contains(pFile.ext.toLowerCase())) {
            ...
            if (pFile.type == 'dir') {
                if (pFile.path == 'trash/')
                    fileIcon += 'file-icon-bin.png'; else
