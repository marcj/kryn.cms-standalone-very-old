ka.windowCombine = new Class({
    ...
    renderActionbar: function () {
        ...
        if (this.values.remove) {
            this.toggleRemoveBtn = this.actionsNavi.addButton(_('Remove'), _path + 'inc/template/admin/images/icons/' + this.values.iconDelete, function () {
                this.toggleRemove();
            }.bind(this));
        }

        if (this.values.add) {
            this.addBtn = this.actionsNavi.addButton(_('Add'), _path + 'inc/template/admin/images/icons/' + this.values.iconAdd, this.add.bind(this));
            /*function(){
