var users_browser = new Class({
    ...
    initialize: function (pWin) {
        ...
        this.buttons = {};
        this.buttons['users'] = this.tabGroup.addButton(_('Users'), _path + PATH_WEB + '/admin/images/icons/user.png',
            this.selectTab.bind(this, 'users'));
        this.buttons['groups'] =
            this.tabGroup.addButton(_('Groups'), _path + PATH_WEB + '/admin/images/icons/group.png',
                this.selectTab.bind(this, 'groups'));
    ...
    doSearch: function () {
        ...
        new Request.JSON({url: _path +
            'admin/users/browser', noCache: 1, onComplete: this.renderResult.bind(this)}).post(req);
