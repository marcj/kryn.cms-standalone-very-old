...
<div class="user-message-system-new-message">
    ...
    <form method="post" action="{$page|@realUrl}" id="user-message-system-new-message-form">
        ...
        <div class="user-message-system-new-message-label">[[recipient]] [[enter the user-id, email-address or the user
            name]]
        </div>
        <div><input type="text" name="to_user_id" value="{$smarty.request.to_user_id}"
                    class="user-message-system-new-message-input"/></div>

        <div class="user-message-system-new-message-label">[[Message subject]]</div>
        <div><input type="text" name="message_subject" value="{$smarty.request.message_subject}" maxlength="255"
                    class="user-message-system-new-message-input"/></div>

        <div class="user-message-system-new-message-label">[[Message text]]</div>
        <div>
            <textarea rows="6" cols="70" name="message_text"
                      class="user-message-system-new-message-textarea">{$smarty.request.message_text}</textarea>
        </div>
