            ...
            <table>
                ...
                {foreach from=$messages item=oneMessage}
                    <tr class="user-message-system-ibox-table-one-message">
                        ...
                        <td>
                            <div onclick="openMessage(this, '{$oneMessage.id}')"
                                 class="user-message-system-one-message-subject one-message-subject-{$oneMessage.message_state}"
                                 title="[[show / hide this message]]">{$oneMessage.message_subject}</div>
                            <div class="user-message-system-one-message-text" style="display:none;">
                                ...
                                <div class="user-message-system-one-message-panel">
                                    {if $newMessagePage}
                                        <a href="{$newMessagePage|@realUrl}?oldMessageRsn={$oneMessage.id}"
                                           class="user-message-system-one-message-respond">[[Respond to]]</a>
                                        <a href="{$newMessagePage|@realUrl}?oldMessageRsn={$oneMessage.id}&amp;type=fwd"
                                           class="user-message-system-one-message-forward">[[Forward to]]</a>
                                    {/if}
                                </div>
                            </div>
                        </td>
                ...
                <tr class="user-message-system-table-footer">
                    ...
                    <td><input type="submit" name="action" value="[[action]]"
                               class="user-message-system-one-message-action-btn"/>
                </tr>
            </table>
            {if $pages > 1 }
