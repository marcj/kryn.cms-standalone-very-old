...
(function () {
    ...
    e.Set = new Class({sets: {}, inherits: {locales: [], sets: {}}, initialize: function (f) {
        ...
        var h = r.indexOf("."), o = h < 0 ? r : r.substr(0, h), k = (this.inherits.sets[o] ||
...
var Sortables = new Class({Implements: [Events, Options
], options: {opacity: 1, clone: false, revert: false, handle: false, dragOptions: {}}, initialize: function (a, b) {
    this.setOptions(b);
    this.elements = [];
    this.lists = [];
    this.idle = true;
    ...
    this.drag = new Drag.Move(this.clone,
        Object.merge({droppables: this.getDroppables()}, this.options.dragOptions)).addEvents({onSnap: function () {
            b.stop();
